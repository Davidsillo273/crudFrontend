...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //Botón "Agregar" resetea el frm y abre modal
    ...
    //Submit del frm (crear/Actualizar producto)
    form.addEventListener("submit", async (e) => {
        ...
        if (file) {
            try {
                ...
                return; //Si falla la subida, no guardamos productos
            }
        }

        //Construcción del payload para enviar a API
        const payload = {
    ...
    async function cargarProductos() {
        try {
            ...
            if (items.length === 0) {
                ...
                td.colSpan = 8;
                td.textContent = "Actualmente no hay registros";
                tr.appendChild(td);
    ...
    //Rellenar frm para editar producto
    ...
    //Resetear frm (al agregar nuevo producto)
