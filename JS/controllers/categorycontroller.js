...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", async (e) => {
        e.preventDefault(); //Evitamos que se el form se mande al hacer "submit"
        ...
        try {
            ...
            //Si no estamos insertando 
            else {
                await createCategory(data);
            }

            modal.hide(); //Se oculta el frm
        ...
        try {
            ...
            categories.forEach((cat)=>{
                ...
                tr.querySelector(".edit-btn").addEventListener("click", ()=>{
                    ...
                    //El modal se carga gasta que el frm ya tenga los datos cargados
                    modal.show();
                });
